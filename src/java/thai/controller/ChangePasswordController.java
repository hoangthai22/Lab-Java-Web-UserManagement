...
public class ChangePasswordController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            txtOldPassword = UserObj.SHA_256(txtOldPassword);
            if (user != null) {
                if (txtOldPassword.equals(user.getPassword()) && txtNewPassword.equals(txtPasswordConfirm)) {
                    UserDAO dao = new UserDAO();
                    txtNewPassword = UserObj.SHA_256(txtNewPassword);
                    dao.updateUserPassword(user.getUserId(), txtNewPassword);
            ...
            LOGGER.info("ERROR at ChangePasswordController:" + e.getMessage());
        } finally {
